...
export default function Miembros() {
  const miembros = Array(12).fill(null).map((_, index) => ({
    id: index + 1,
  ...
  return (
    ...
    >
      ...
      {/* Character Image on the left (solo en desktop) */}
      <div className="w-1/3 flex items-center justify-center p-8 relative hidden lg:flex">
        {/* ...tu código del líder aquí, igual que antes... */}
        {/* Puedes dejar el motion.div del líder aquí */}
        <motion.div 
      ...
      <div className="flex-1 p-8 relative z-10 flex flex-col gap-8">
        ...
        {/* Líder SOLO en tablet y mobile */}
        <div className="lg:hidden flex justify-center mb-8">
          {/* Copia aquí el motion.div del líder */}
          <motion.div
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
          {/* En desktop muestra todos, en tablet/mobile omite el líder */}
          {(window.innerWidth >= 1024 ? miembros : resto).map((miembro, index) => (
            <motion.div
              key={miembro.id}
